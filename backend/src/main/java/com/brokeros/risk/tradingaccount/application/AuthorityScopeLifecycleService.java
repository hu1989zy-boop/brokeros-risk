...
public final class AuthorityScopeLifecycleService {
    ...
    public AuthorityScopeLifecycleService(
    ...
    public LifecycleChangeResult change(ActorContext actorContext, AuthorityOperationRequest request) {
        ...
        try {
            LifecycleChangeResult result = mutationPort.changeScopeLifecycle(
                    new ChangeScopeLifecycleSpec(request), context);
